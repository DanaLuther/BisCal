...
-- ***************************************************************************************************************************************************
-- * 0.6.0 / 2015.10.14 / Llien: Updated event restrictions to allow for level 65 - Thanks Jbattut
...
local function EventPopup(parent)
	...
	function popup:SetData(eventID, eventData)
		...
		if eventData.restrictLevel then
			...
			maxLevelSlider:SetPosition(eventData.restrictLevel[2] or 70)
		else
			levelCheck:SetChecked(false)
		end
