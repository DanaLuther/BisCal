...
-- * Main BiSCal frame                                                                                                                               *
-- ***************************************************************************************************************************************************
-- * 0.6.0 / 2015.10.28 / Llien: Detached frame layout from Guild Window due to bugs with Native:GetBounds()                                         *
...
local function InitializeUI()
	...
	local aX,aY,bX,bY = NativeGuildFrame:GetBounds()
	if aX == 0 and aY == 0 then  
		-- If the UI is bugged, don't attach to the native guild window
		mainFrame:SetPoint("TOPCENTER", UIParent, "TOPCENTER", 0, 40 )
		mainFrame:SetWidth(852)
		mainFrame:SetHeight(500)

		tabControl:SetPoint("TOPCENTER", UIParent ,"TOPCENTER", 30, -2)
		tabControl:SetWidth(890)
	else
